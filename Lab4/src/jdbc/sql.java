...
public class sql {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/pomonatransitsystem", "root", "pass");
	...
	public static void displayWeekly(Statement stmt) throws SQLException, ParseException{
		Scanner sc = new Scanner(System.in);
		System.out.print("Driver name: ");
		String driver = sc.nextLine().trim();
		System.out.print("Date: ");
